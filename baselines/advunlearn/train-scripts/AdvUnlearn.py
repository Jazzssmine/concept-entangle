...
# Ensure repo root is on sys.path so that `ldm` and `utils` can be imported
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', help='ckpt path for stable diffusion v1-4', type=str, required=False, default='/work/hdd/bcxt/anon3/unlearn_diff/stable-diffusion/sd-v1-4-full-ema.ckpt')
